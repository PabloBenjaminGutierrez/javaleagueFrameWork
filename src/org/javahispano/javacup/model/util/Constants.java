...
public final class Constants {
    ...
    /**
     * Altura maxima en que los jugadores pueden controlar el balon, solo el
     * portero puede controlar hasta ALTO_ARCO
     */
    ...
    /**
     * Aceleracion minima de un jugador al hacer un cambio de direccion en el
     * eje Y*
     */
    ...
    /**
     * Incremento de la aceleracion en cada iteraccion si no se cambia de
     * direccion*
     */
    ...
    //#######################################################
    /**
     * Parametro para configurar como la camara sigue la posicion del balon,
     * mientra mayor sea mas suave seran los movimientos de la camara
     */
    public static final double SEGUIMIENTO_CAMARA = 20;
    /**
     * Cantidad de iteraciones que tienen que pasar para que un mismo jugador
     * vuelva a rematar
     */
    public static final int ITERACIONES_GOLPEAR_BALON = 10;
    /**
     * Cantidad maxima de iteraciones para sacar, si se sobrepasan el equipo
     * contrario sacara
     */
    ...
    /**
     * Distancia minima que puede estar un jugador rival mientras se realiza un
     * saque
     */
    ...
    /**
     * Retorna la velocidad de remate (en [metros/iteracion]) dado un
     * factor[0..1];
     */
    ...
    /**
     * Retorna la velocidad de un jugador (en [metros/iteracion]) dado un
     * factor[0..1];
     */
