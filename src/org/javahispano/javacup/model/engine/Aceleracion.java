...
public class Aceleracion {
    ...
    //  Aceleracion en el eje X e Y, valor entre 0 y 1
    ...
    //Direccion en el eje X e Y. Valores -1, 0 (DETENIDO) y 1
    ...
    public void actualizar(Position posActual) {
        ...
        if (anteriorDireccionX != direccionX) {
            ...
            if (aceleracionX > 1) {
                aceleracionX = 1; //M�ximo de la acelaracion
            }
        }
        ...
        if (anteriorDireccionY != direccionY) {
            ...
            if (aceleracionY > 1) {
                aceleracionY = 1; //M�ximo de la acelaracion
            }
        }
