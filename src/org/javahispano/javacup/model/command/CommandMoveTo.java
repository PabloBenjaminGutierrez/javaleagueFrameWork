...
public final class CommandMoveTo extends Command {
     ...
     */
    /**
     * Instancia el comando "ir a" indicando el indice del jugador y hacia que
     * direccion se debe dirigir
     */
    ...
    /**
     * Instances "Move to " command with the player index, position and if
     * player is sprinting
     */
    /**
     * Instancia el comando "ir a" indicando el indice del jugador, la posicion
     * hacia que direccion se debe dirigir y si esta en sprint
     */
