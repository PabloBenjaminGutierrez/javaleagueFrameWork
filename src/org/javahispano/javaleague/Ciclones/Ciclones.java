package org.javahispano.javaleague.Ciclones;
...
public class Ciclones implements Tactic {
    ...
    Position alineacion1[] = new Position[]{
        /**
         * new Position(0.2595419847328244,-50.41044776119403), new
         * Position(-20.20979020979021,-13.303167420814479), new
         * Position(-11.888111888111888,-27.556561085972852), new
         * Position(10.937062937062937,-27.794117647058822), new
         * Position(17.832167832167833,-13.540723981900454), new
         * Position(-29.006993006993007,0.47511312217194573), new
         * Position(1.902097902097902,10.214932126696834), new
         * Position(-1.188811188811189,-9.97737556561086), new
         * Position(27.81818181818182,0.47511312217194573), new
         * Position(-14.027972027972028,19.95475113122172), new
         * Position(12.363636363636363,26.84389140271493) *
         */
    ...
    public List<Command> execute(GameSituations sp) {
        ...
        for (int indJugador : posiblesRematadores) {
            ...
            if (sp.isStarts()) {
            ...
            } else if (indJugador == Christian || indJugador == Picos) {
                if (r.nextBoolean()) {
                ...
                /**
                 * if (distanciaJugadorRival <=5) { double balonX = 0; double
                 * balonY = 0;
                 *
                 * balonY = Constants.cornerSupIzq.getY() + 10; if
                 * (sp.ballPosition().getX() < 0) { balonX = -30; } else {
                 * balonX = 30; } comandos.add(new CommandHitBall(indJugador,
                 * new Position(balonX, balonY), 1, true)); } else {*
                 */
