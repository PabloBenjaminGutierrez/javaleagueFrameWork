package org.javahispano.javaleague.cucarachaAru;
    ...
    class TacticDetailImpl implements TacticDetail {
        ...
        public PlayerDetail[] getPlayers() {
            return new PlayerDetail[]{
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("El Guapo", 1, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.87d, 0.71d, 0.91d, true),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Refri", 2, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.8d, 0.8d, 0.85d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Popochin", 3, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.77d, 0.81d, 0.84d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Pambi Edward", 4, new Color(51, 255, 0),
                new Color(50, 0, 0), 0.88d, 0.83d, 0.93d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Angel Bigotes", 5, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.88d, 0.76d, 0.93d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Marco", 6, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.76d, 0.76d, 0.9d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Gerard", 7, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.96d, 0.87d, 0.79d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Saul", 8, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.9d, 0.84d, 0.68d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Rubaz", 9, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.78d, 0.87d, 0.77d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("Zesar", 10, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.84d, 0.84d, 0.94d, false),
                new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl.JugadorImpl("El Tio", 11, new Color(255, 204, 102),
                new Color(50, 0, 0), 0.75d, 0.88d, 0.79d, false)};
        }
    }

    TacticDetail detalle = new org.javahispano.javaleague.cucarachaAru.TacticaCucaracha.TacticDetailImpl();
        ...
        if (sp.canKick().length > 0) {
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if (puedeMeterGol(jugadoresRivales, rivalesMasCarcanos, jugadores[jugadorConBalon])) {
                    comandos.add(new CommandHitBall(jugadorConBalon, posicionTiro, 1, 12));
                    ...
                    if (encontroJugadorDestino && opcionJugAdelante
                        ...
                        } else if (encontroJugadorDestino && opcionJugAdelante && (jugadores[jugadorMejorOpcion].getX() > 25 || jugadores[jugadorMejorOpcion].getX() < -25)) {
                            comandos.add(new CommandHitBall(jugadorConBalon, Constants.centroArcoSup, 1, 17));
